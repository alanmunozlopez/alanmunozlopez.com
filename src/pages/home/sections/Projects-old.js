  ...
  <div className="Projects">
    <div className="Projects-container">
      ...
      <div className="Projects-item-text color--white">
        <p>
          Currently I'm working as fullStack developer using Javascript: VueJS, ReactJS and NodeJS. This with Grid Css, Vuex, Redux, Express, Jest and more.
        </p>
      </div>
      <div className="Projects-item-image">
        <img src={coopeuchLogo} className="Description-image-display" alt="logo" />
      ...
      <div className="Projects-item-text color--white">
        <p>
          I have designed and fully implemented an app called cutsmode. This app is used by Djs as a complement during their presentations. This app was developed on Ionic framework for <a rel="noopener noreferrer" href="https://itunes.apple.com/us/app/cutsmode/id1253241533" target="_blank">iOS</a> and <a rel="noopener noreferrer" href="https://play.google.com/store/apps/details?id=app.cutsmode.com" target="_blank">Android.</a>
        </p>
      </div>
      <div className="Projects-item-image">
      ...
      <div className="Projects-item-text color--white">
        <p>
          I have implemented a mobile app called plantsss which is about locating plants on my neighborhood. This app was implemented as a native <a rel="noopener noreferrer" href="https://itunes.apple.com/cl/app/plantsss-radar/id1241695864" target="_blank">iOS</a> app using Swift programming language and MySQL as the database also the server side components were deployed on Amazon AWS.
        </p>
      </div>
      <div className="Projects-item-image">
