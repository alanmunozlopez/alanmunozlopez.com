  ...
  <div className="Projects">
    <div className="Projects-container">
      ...
      <div className="Projects-item-text color--white">
        <p> Currently I'm working as fullStack developer using Javascript: VueJS, ReactJS and NodeJS. This with Grid Css, Vuex, Redux, Express, Jest and more. </p>
      </div>
      <div className="Projects-item-image">
